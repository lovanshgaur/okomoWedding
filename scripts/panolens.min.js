(function(k, d) {
    ...
    function da(a, b) {
        ...
        // Request permission as soon as the instance is created (for iOS 13+)
        this.requestPermission = function () {
            if (typeof DeviceOrientationEvent !== "undefined" && typeof DeviceOrientationEvent.requestPermission === "function") {
                // Check if we're on iOS and permission is needed
                DeviceOrientationEvent.requestPermission().then(function (response) {
                    if (response === "granted") {
                        // If permission is granted, initialize device orientation updates
                        c.connect();
                    } else {
                ...
                // For devices not requiring permission, we initialize the connection directly
                c.connect();
            }
        };
        ...
        // Call the permission request as soon as the object is created
